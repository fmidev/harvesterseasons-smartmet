...
input3=ec-ens/ECC_${year}${month}${day}T000000_laihv-nd-day.grib
input4=ec-ens/ECC_${year}${month}${day}T000000_lailv-nd-day.grib
input5=ec-ens/SWIC_${year}${month}${day}T000000_2020_2015-2022_swis-ydaymean-nd-9km-fixed.grib
...
seq 0 50 | parallel --tmpdir /home/ubuntu/data/tmp cdo -b 16 -f grb2 copy -setparam,41.228.192 -setmissval,-9.e38 ec-ens/ECXENS_${year}${month}${day}_swi2_${era}_nd-out-{}.nc ec-ens/ECXENS_${year}${month}${day}_swi2-${era}-nd-out-{}.grib || echo "NO input or already netcdf to grib"
