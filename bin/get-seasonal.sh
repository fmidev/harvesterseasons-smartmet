...
[ -f ec-sf-$year$month-pl-12h-euro.grib ] && [ ! -f grib/ECSF_$year${month}01T000000_pl-pp-12h-euro.grib ] && \
 cdo --eccodes -O -b P12 \
    ...
    -aexpr,'wdir=180+180/3.14159265*2*atan(v/(sqr(u^2+v^2)+u));' \
        -aexpr,'vp=clev(q)*q/(0.622+0.378*q);' ec-sf-$year$month-pl-12h-euro.grib \
        grib/ECSF_$year${month}01T000000_pl-pp-12h-euro.grib ||\
