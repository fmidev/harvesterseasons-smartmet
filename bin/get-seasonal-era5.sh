...
seq 0 50 | parallel -j 16 --compress --tmpdir tmp/ cdo --eccodes ymonmul \
    -remapbil,era5-eu-grid -selvar,e,tp,sd ens/ec-sf_$year${month}_all-24h-eu-{}.grib \
    -selmonth,$mon1,$mon2,$mon3,$mon4,$mon5,$mon6,$mon7,$mon8 -selvar,e,tp,sd era5/era5-ecsf_2000-2019_bound_bias.grib \
...
cdo -f nc4 copy grib/ECB2SF_$year${month}01T0000_unbound-24h-eu.grib grib/ECB2SF_$year${month}01T0000_bound-24h-eu.grib grib/ECB2SF_$year${month}01T0000_stl-24h-eu.grib ../bin/harvester_code_hops/data/ecmwf/domains/scandi/fcast_ens/ec-sf-$year$month-b2all-24h-eu.nc
