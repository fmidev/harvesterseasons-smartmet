...
#print('/home/smartmet/data/ec-sf-%s%s-all-24h.grib'%(year,month))
c = cdsapi.Client()
...
c.retrieve(
    'seasonal-original-single-levels',
    {
        ...
        'variable': [
            ...
            'sea_ice_cover', 'sea_surface_temperature', 'snow_density',
            'snow_depth', 'snowfall', 'soil_temperature_level_1','39.128', '40.128', '41.128','42.128', 
    ...
    '/home/smartmet/data/ec-sf-%s%s-all-24h-nordic.grib'%(year,month))
