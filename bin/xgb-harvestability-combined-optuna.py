...
cols_own= ["DTM_height","DTM_slope","DTM_aspect","TCD","WAW","CorineLC","TWI","TH_LONG","TH_LAT","harvestability"]
...
all_data = pd.concat([train_samples,test_samples])
...
### Optuna trials
study = optuna.create_study(storage="sqlite:///MLexperiments.sqlite3",study_name="harvestability-combined-lon-lat-1",direction="maximize")
