...
wget -c --no-check-certificate -r -np -nd -q --user=mstrahl --password='Hehe-c3po' -R '*.html' https://datalsasaf.lsasvcs.ipma.pt/PRODUCTS/EPS/EDLST/NETCDF/$y/$m/$d/ && \
 cdo --eccodes -s -f grb2 -z aec -b P8 setname,skt -selname,LST-day $trpa/NETCDF4_LSASAF_M01-AVHR_EDLST-DAY_GLOBE_${ymd}0000.nc grib/LSASAF_20000101T120000_${ymd}_lst-day-gl.grib && \
  cdo --eccodes -s -f grb2 -z aec -b P8 setname,skt -selname,LST-night $trpa/NETCDF4_LSASAF_M01-AVHR_EDLST-NIGHT_GLOBE_${ymd}0000.nc grib/LSASAF_20000101T000000_${ymd}_lst-night-gl.grib && \
