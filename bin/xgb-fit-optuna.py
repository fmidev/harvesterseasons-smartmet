...
# note: atm does not save mdls!!!! fix
startTime=time.time()
...
def objective(trial):
    # read data from csv file with all stations cat in one file (faster)
    # many stations: read in in chunks
    ...
    ### optuna trial & xgb hyperparameters
    param = {
...
### Optuna trial
study = optuna.create_study(storage="sqlite:///db.sqlite3",study_name="xgb-optuna-test1",direction="minimize")
